...
export const Hero = () => {
    return (
        <div className="relative w-full flex flex-col items-center justify-center pt-30">
            ...
            {/* poweredby */}
            <div className="relative bottom- flex items-center gap-5 px-8 py-3 rounded-2xl border border-white/40 bg-white/20 backdrop-blur-xl shadow-sm opacity-80 hover:opacity-100 transition-all duration-500 hover:border-white/60 cursor-default mb-10">
