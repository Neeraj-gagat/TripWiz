...
//         </svg>
//         <span className="text-xs font-black text-slate-800">{hotel.starRating}</span>
//       </div>
...
//           <span className="text-sm font-black">{hotel.dailyRate}</span>
//           <span className="text-[9px] font-bold text-slate-300 uppercase tracking-tighter ml-1">/ nt</span>
//         </div>
//       </div>
//     </div>
...
//         {hotel.tags.map(tag => (
//           <span key={tag} className="px-2.5 py-0.5 bg-slate-50 text-slate-500 rounded-lg text-[9px] font-black uppercase tracking-wider border border-slate-100 group-hover:bg-pink-50 group-hover:text-pink-600 group-hover:border-pink-100 transition-colors">
//             {tag}
//           </span>
//         ))}
//       </div>

//       <button className="w-full bg-[#1a2b48] text-white py-3 rounded-xl font-black text-[10px] uppercase tracking-[0.2em] hover:bg-[#e91e63] transition-all transform hover:scale-[1.03] active:scale-95 shadow-md hover:shadow-pink-200">
//         View Deal
//       </button>
//     </div>
//   </div>
